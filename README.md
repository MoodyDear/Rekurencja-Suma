This is a simple graphical user interface (GUI) application built using Python’s Tkinter library that calculates the recursive sum of all numbers from 1 to a given number. 
